...
class SearchableIconDropdown extends StatefulWidget {
  final Map<IconData, String> iconMap;
  final IconData? selectedIcon;
  final ValueChanged<IconData> onIconSelected;

  const SearchableIconDropdown({
    super.key,
  ...
  @override
  State<SearchableIconDropdown> createState() => _SearchableIconDropdownState();
}

class _SearchableIconDropdownState extends State<SearchableIconDropdown> {
